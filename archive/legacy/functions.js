...
jQuery($=> {
    ...
    $("#submit_btn1 , #submit_btn").on('click', function () {
        ...
        if (proceed) {
            ...
            output = '<div class="alert-danger" style="padding:10px; margin-bottom:25px;">Please provide the missing fields.<button type="button" class="close" onclick="closeAlert(this)">x</button></div>';
            result.slideUp("fast").html(output).slideDown();
        }
    });
    /*rating stars*/
...
//                 $(".menutop").css({"margin-top": "3rem", });
    ...
    $("#services-slider-one").owlCarousel({
        autoplay: false,
        autoplayTimeout: 3000,
        autoplayHoverPause: true,
        smartSpeed: 1200,
